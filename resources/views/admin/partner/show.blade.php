            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @if (is_file('uploads/' . $path . '/' . $row->image_path))
                        ...
                        <img src="{{ asset('uploads/' . $path . '/' . $row->image_path) }}" class="img-fluid"
                            alt="Logo">
                    @endif
                    ...
                    @if (!empty($row->link))
                        <hr />
                        <p><span class="badge badge-primary">{{ __('dashboard.web_link') }}:</span> <a
                                href="{{ $row->link }}" target="_blank">{{ $row->link }}</a></p>
                    @endif
