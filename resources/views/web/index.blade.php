        ...
        <section class="our-mission-section">
            <div class="container">
                @if (isset($about))
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 wow fadeInRight animated">
                            <div class="inner-box">
                                ...
                                @endphp
                                @if (isset($page_about))
                                    <div class="link-box"><a href="{{ route('about') }}"
                                            class="theme-btn btn-style-three">{{ __('common.read_more') }}</a></div>
                                @endif
                            </div>
                        </div>
                        {{--
                                        ...
                                        <div class="counter-column col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
                                            <div class="count-box">
                                                <div class="count"><span class="count-text" data-speed="5000"
                                                        data-stop="{{ $counter->value }}">0</span></div>
                                                <div class="separater"></div>
...
--}}
                        ...
                        @foreach ($members as $member)
                            ...
                            <div class="team-block">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <div class="image"><img
                                                src="{{ asset('uploads/member/' . $member->image_path) }}"
                                ...
                                <div class="news-block">
                                    <div class="inner-box">
                                        <div class="image-box">
                                            ...
                                            <div class="overlay-box"><a href="{{ route('blog.single', $article->slug) }}"
    ...
    <!-- clientels -->
    <section class="slide-option" style="padding: 75px 0 0;">
        <div class="container">
            <div class="sec-title centered">
                <h2>Our Clients</h2>
                <div class="text"></div>
        ...
        <div id="infinite" class="highway-slider">
            <div class="highway-barrier">
                <ul class="highway-lane">
                    <li class="highway-car"><img src=" {{ asset('images/clients/annapurnaM.png') }} " /></li>
                    <li class="highway-car"><img src=" {{ asset('images/clients/cc.png') }} " /></li>
                    <li class="highway-car"><img src=" {{ asset('images/clients/esewa.png') }} " /></li>
                    <li class="highway-car"><img src=" {{ asset('images/clients/fone.png') }} " /></li>
                    <li class="highway-car"><img src=" {{ asset('images/clients/Hard-Rock-Cafe-Logo-1981.png') }} " />
                    </li>
                    <li class="highway-car"><img src=" {{ asset('images/clients/j.png') }} " /></li>
                    <li class="highway-car"><img src=" {{ asset('images/clients/jobs.png') }} " /></li>
                    <li class="highway-car"><img src=" {{ asset('images/clients/karkhana.png') }} " /></li>
                    <li class="highway-car"><img src=" {{ asset('images/clients/kcm.png') }} " /></li>
                    <li class="highway-car"><img src=" {{ asset('images/clients/kn.png') }} " /></li>
                    <li class="highway-car"><img src=" {{ asset('images/clients/nicAsia.png') }} " /></li>
                    <li class="highway-car"><img src=" {{ asset('images/clients/presidental.png') }} " /></li>
                    <li class="highway-car"><img src=" {{ asset('images/clients/savlon.png') }} " /></li>
                    <li class="highway-car"><img src=" {{ asset('images/clients/skoda-logo.png') }} " /></li>
                    <li class="highway-car"><img src=" {{ asset('images/clients/sukalpa.png') }} " /></li>
                    <li class="highway-car"><img src=" {{ asset('images/clients/suzuki.png') }} " /></li>
                    <li class="highway-car"><img src=" {{ asset('images/clients/veda.png') }} " /></li>
